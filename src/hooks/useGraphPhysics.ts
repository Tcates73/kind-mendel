...
export const useGraphPhysics = (nodes: MemoryNode[]) => {
  ...
  // Bolt Optimization: Wrap updateNodePosition and releaseNode in useCallback to maintain stable references,
  // preventing unnecessary child component re-renders and reducing object allocations.
